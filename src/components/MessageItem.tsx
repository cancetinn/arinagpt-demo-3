...
export default ({ role, message, showRetry, onRetry }: Props) => {
  const roleClass = {
    system: 'bg-gradient-to-r from-blue-200 via-blue-500 to-blue-800',
    user: 'bg-gradient-to-r from-gray-400 to-black-400',
    assistant: 'bg-gradient-to-r from-blue-200 via-blue-500 to-blue-800',
  }
  ...
  return (
    <div class="py-2 -mx-4 px-4 transition-colors md:hover:bg-slate/3">
      <div class="flex gap-3 rounded-lg" class:op-75={role === 'Super Admin'}>
